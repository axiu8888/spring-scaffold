...
public class CacheService {
  ...
  public SysUser getUser(String userId) {
    return getValue(Const.keyUserInfo(userId), SysUser.class);
  }
  ...
  public SysAccount getAccount(String username) {
    return getValue(Const.keyAccount(username), SysAccount.class);
  }
   ...
   * @return 返回账号
   */
  public SysAccount getAccountByUserId(String userId) {
